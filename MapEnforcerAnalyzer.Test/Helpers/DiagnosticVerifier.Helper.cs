    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        protected static Diagnostic[] GetSortedDiagnosticsFromDocuments(DiagnosticAnalyzer analyzer, Document[] documents)
        {
            ...
            foreach (var project in projects)
            {
                ...
                var parseDiags = compilationWithAnalyzers.Compilation.GetParseDiagnostics();
                if (parseDiags.Any())
                {
                    throw new Exception($"Compilation failed with an error not generated by the tested diagnostic: {parseDiags.First()}");
                }

                var allDiags = compilationWithAnalyzers
                    .GetAllDiagnosticsAsync()
                    .Result
                    .Where(d => d.Id != "CS5001"); // we don't care about missing entry point
